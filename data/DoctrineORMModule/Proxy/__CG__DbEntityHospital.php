 ...
 */
class Hospital extends \Db\Entity\Hospital implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Db\\Entity\\Hospital' . "\0" . 'id', '' . "\0" . 'Db\\Entity\\Hospital' . "\0" . 'name', '' . "\0" . 'Db\\Entity\\Hospital' . "\0" . 'city', '' . "\0" . 'Db\\Entity\\Hospital' . "\0" . 'inactive'];
        }
    ...
    public function setInactive($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInactive', [$value]);

        return parent::setInactive($value);
    }
